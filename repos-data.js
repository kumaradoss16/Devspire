const CATS = {
    ...
    mobile: { label: "Mobile", emoji: "📱", desc: "iOS & Android tools", color: "#f472b6", dim: "rgba(244,114,182,.09)", border: "rgba(244,114,182,.28)" }
};
...
const REPOS = [
  ...
  },
  {
    ...
    },
    {
        ...
        "cat": "ai",
        "desc": "TokenSpeed is a speed-of-light LLM inference engine.",
        "language": "Python",
    ...
    },
    {
        ...
        cat: "ai",
        desc: "DeepSeek 4 Flash local inference engine for Metal.",
        language: "C",
    ...
    },
    {
        ...
        cat: "ai",
        desc: "A unified virtual filesystem for AI agents, supporting bash, Claude Code, LangChain, and OpenAI agent sandboxes.",
        language: "TypeScript",
    ...
    },
    {
        ...
        cat: "security",
        desc: "A low-level security or exploitation tool written in C.",
        language: "C",
    ...
    },
    {
        ...
        cat: "ai",
        desc: "Terminal-native coding agent powered by local LLMs — 100% open source, free forever, installed with a single command, built on C#/.NET infrastructure.",
        language: "C#",
    ...
    },
    {
        ...
        cat: "dev",
        desc: "Voidstrap is a simple yet advanced fork of Bloxstrap with advanced customization and improvements for Roblox.",
        language: "C#",
    ...
    {
        owner: "Kappaemme-git",
        name: "codex-startup-pressure-test-skill",
        url: "https://github.com/Kappaemme-git/codex-startup-pressure-test-skill",
        cat: "dev",
        desc: "A Codex skill for startup pressure testing.",
        language: "JavaScript",
    ...
    },
    {
        ...
        cat: "dev",
        desc: "Run Claude Code from a USB drive on any PC with no installation required.",
        language: "HTML",
    ...
    },
    {
        ...
        cat: "ai",
        desc: "Build a modern LLM from scratch with every line commented, explained simply using attention mechanisms, transformers, and PyTorch.",
    ...
    },
    {
        ...
        cat: "dev",
        desc: "Public gallery of animated Codex pets.",
        language: "TypeScript",
    ...
    },
    {
        ...
        cat: "ai",
        desc: "An auto-evolving AI ops expert that learns your social media account patterns using Claude Code workflows, designed to grow followers rapidly.",
        language: "Python",
    ...
    },
    {
        ...
        cat: "dev",
        desc: "A simple Markdown viewer for reading .md files on macOS.",
        language: "Swift",
    ...
    },
    {
        ...
        cat: "ai",
        desc: "Hermes-native AIOps agent for evidence-driven incident response, approval-gated remediation, and runbook learning.",
        language: "Python",
    ...
    },
    {
        ...
        cat: "security",
        desc: "Deepsec is a security harness for finding vulnerabilities in your codebase powered by coding agents.",
        language: "TypeScript",
    ...
    },
    {
        ...
        cat: "mobile",
        desc: "Headless iOS Simulator manager and farm with host-side input injection for iOS 26, supporting taps, swipes, multi-finger gestures, and 60fps streaming.",
        language: "Swift",
    ...
    },
    {
        ...
        cat: "ai",
        desc: "Use Claude Code autonomous agent loop with DeepSeek V4 Pro, OpenRouter, or any Anthropic-compatible backend at 17x lower cost.",
        language: "JavaScript",
    ...
    },
    {
        ...
        cat: "dev",
        desc: "A TDD-driven iterative feedback loop for software development using 16 cohesive Claude Code skills that walk an idea from brainstorm to plan, execute, and iterate.",
        language: "Shell",
    ...
    },
    {
        ...
        cat: "ai",
        desc: "Community recipes for serving LLMs on RTX 3090 using multiple engines (vLLM, llama.cpp, SGLang), currently shipping Qwen3.6-27B configs for 1x and 2x cards.",
        language: "Shell",
    ...
    },
    {
        ...
        cat: "dev",
        desc: "A backup-first Codex skill for keeping local Codex state fast, clean, and recoverable.",
        language: "Python",
    ...
    },
    {
        ...
        cat: "security",
        desc: "Exploit proof-of-concept for CVE-2026-31431.",
        language: "Python",
    ...
    },
    {
        ...
        cat: "ai",
        desc: "Transform legacy systems into executable specifications for AI coding agents.",
        language: "JavaScript",
    ...
    },
    {
        ...
        cat: "dev",
        desc: "The npx serve equivalent for Apple Simulators.",
        language: "TypeScript",
    ...
    },
    {
        ...
        cat: "ai",
        desc: "AI coding jargon explained in plain English.",
        language: "TypeScript",
    ...
    },
    {
        ...
        cat: "network",
        desc: "Socks5 VPN that tunnels raw TCP through Google Apps Script to your VPS exit server using AES-256-GCM encryption and domain-fronting.",
        language: "Go",
    ...
    },
    {
        ...
        cat: "dev",
        desc: "PPT image-first skill for Codex, Claude Code, and Opencode CLI.",
        language: "Python",
    ...
    },
    {
        ...
        cat: "dev",
        desc: "Open-source, lightweight, cross-platform database client supporting MySQL, PostgreSQL, SQLite, Redis, MongoDB, DuckDB, ClickHouse, and SQL Server.",
        language: "Vue",
    ...
    },
    {
        ...
        cat: "mobile",
        desc: "macOS menu bar app that tells you, in plain English, what each USB-C cable plugged into your Mac can actually do.",
        language: "Swift",
    ...
    },
    {
        ...
        cat: "web",
        desc: "Open-source launcher for macOS with Raycast-compatible extensions, voice workflows, and AI-native actions.",
        language: "TypeScript",
        topics: ["typescript"],
    ...
    },
    {
        ...
        cat: "ai",
        desc: "PicoLM was built as the local brain for PicoClaw — an ultra-lightweight AI assistant in Go that runs on $10 hardware.",
        language: "C",
    ...
    },
    {
        ...
        cat: "ai",
        desc: "Soul-driven AI agent with permission-hardened tools, token budgets, and multi-channel access. Runs 24/7 from CLI or Telegram.",
        language: "TypeScript",
        topics: ["ai_agent", "ai_assistant", "llm"],
    ...
    },
    {
        ...
        cat: "ai",
        desc: "Python library providing an API wrapper for ChatGPT interactions.",
        language: "Python",
        topics: [],
        updated: "26 April 2026",
        isNew: false
    },
    {
        ...
        cat: "dev",
        desc: "ClawSweeper scans all issues and PRs and suggest what we can close, and why. It runs every PR / Issue once a week.",
        language: "JavaScript",
        topics: [],
        updated: "26 April 2026",
        isNew: false
    },
    {
        ...
        cat: "security",
        desc: "Rust port of MasterHttpRelayVPN. Free DPI bypass via a Google Apps Script relay with TLS SNI concealment. CLI + cross-platform desktop UI, HTTP + SOCKS5 proxy, no runtime deps.",
        language: "Rust",
        topics: ["anti_censorship", "censorship_circumvention", "cross_platform", "desktop_app", "domain_fronting", "dpi_bypass", "egui", "google_apps_script", "gui", "http_proxy", "iran", "mitm", "proxy", "rust", "sni", "socks5", "tls"],
        updated: "26 April 2026",
        isNew: false
    },
    {
        ...
        cat: "ai",
        desc: "Portable AI agent orchestration with mechanical protocol enforcement. 186 agents, zero runtime dependencies.",
        language: "Python",
        topics: ["agent_framework", "agent_system", "ai_agents", "claude_code", "cursor_ide", "llm", "multi_agent_framework", "orchestration", "prompt_engineering", "python"],
    ...
    },
    {
        owner: "MrsEWE44",
        name: "musicDownload",
        url: "https://github.com/MrsEWE44/musicDownload",
        cat: "dev",
        desc: "Python-based music download utility.",
        language: "Python",
        topics: [],
        updated: "27 April 2026",
        isNew: false
    ...
    {
        owner: "Russell-cell",
        name: "PPT-Design-Prompt",
        url: "https://github.com/Russell-cell/PPT-Design-Prompt",
        cat: "ai",
        desc: "Python tool for generating PowerPoint design prompts.",
        language: "Python",
        topics: [],
        updated: "27 April 2026",
        isNew: false
    },
    {
        ...
        cat: "ai",
        desc: "An open source harness for generating CAD models.",
        language: "JavaScript",
        topics: ["agents", "ai", "ai_agents", "cad", "text_to_cad", "wasm"],
        updated: "27 April 2026",
        isNew: false
    },
    {
        ...
        cat: "ai",
        desc: "GPT Image 2 prompt gallery, image prompt library, agentic skill, and CLI for OpenAI image generation/editing.",
        language: "Python",
        topics: ["agent_skills", "ai_image_prompts", "claude_code_skill", "cli", "codex_skill", "gpt_image", "gpt_image_2", "image_editing", "image_generation", "openai", "prompt_library", "text_to_image"],
    ...
    },
    {
        ...
        cat: "ai",
        desc: "Agent Skill for generating 2D sprite sheets, transparent PNG frames, and animated GIFs from prompts.",
        language: "Python",
        topics: ["agent_skills", "codex", "pixel_art", "sprite_generator"],
        updated: "28 April 2026",
        isNew: false
    },
    {
        ...
        cat: "ai",
        desc: "Open-source, end-to-end platform for evaluating, observing, and improving LLM and AI agent applications. Tracing, Evals, Simulations, Datasets, Gateway, Guardrails. Self-hostable.",
        language: "Python",
        topics: ["ai", "ai_gateway", "evals", "llm", "observability", "simulation"],
        updated: "28 April 2026",
        isNew: false
    },
    {
        ...
        cat: "ai",
        desc: "OpenAI-compatible proxy that aggregates free-tier keys from 14 AI providers with automatic failover.",
        language: "TypeScript",
        topics: [],
        updated: "28 April 2026",
        isNew: false
    },
    {
        owner: "avaco-cloud",
        name: "Vercel-XHTTP",
        url: "https://github.com/avaco-cloud/Vercel-XHTTP",
        cat: "network",
        desc: "XHTTP relay for Xray/V2Ray on Vercel Edge. Hides origin server IP behind *.vercel.app.",
        language: "JavaScript",
        topics: [],
    ...
    },
    {
        ...
        cat: "ai",
        desc: "AI text rewriting skill to make content appear human-written.",
        language: "Python",
        topics: [],
        updated: "29 April 2026",
        isNew: false
    },
    {
        ...
        cat: "ai",
        desc: "Local-first, open-source alternative to Anthropic's Claude Design. 19 Skills, 71 brand-grade Design Systems, sandboxed preview, HTML/PDF/PPTX export.",
        language: "TypeScript",
        topics: ["ai_agents", "ai_design", "anthropic", "byok", "claude", "claude_code", "codex", "design", "design_systems", "design_tools", "gemini_cli", "generative_ai", "llm", "local_first", "react", "typescript"],
        updated: "29 April 2026",
        isNew: false
    },
    {
        ...
        cat: "ai",
        desc: "Persistent memory layer for AI agents. Episodes, facts, and working context stored in Postgres. MCP server included. Self-hosted, single binary, no cloud required.",
        language: "Go",
        topics: ["ai", "ai_agents", "ai_memory", "memory"],
        updated: "29 April 2026",
        isNew: false
    },
    {
        ...
        cat: "ai",
        desc: "Shell-based automation skills for social media workflows.",
        language: "Shell",
        topics: [],
    ...
    },
    {
        owner: "NullLatency",
        name: "FlowDriver",
        url: "https://github.com/NullLatency/FlowDriver",
        cat: "security",
        desc: "Bypass restrictive networks by tunneling SOCKS5 traffic through legitimate Google Drive API requests.",
        language: "Go",
        topics: ["covert_transport", "dpi", "google_drive", "google_drive_api", "sni", "tunneling", "vpn"],
        updated: "30 April 2026",
        isNew: false
    },
    {
        ...
        cat: "dev",
        desc: "Collection of recipes and examples for the Cursor AI code editor.",
        language: "TypeScript",
        topics: [],
        updated: "30 April 2026",
        isNew: false
    },
    {
        ...
        cat: "security",
        desc: "Proof-of-concept exploit for CVE-2026-31431 copy failure vulnerability.",
        language: "Python",
        topics: [],
        updated: "30 April 2026",
        isNew: false
    },
    {
        ...
        cat: "systems",
        desc: "Linux payload implementing the HV exploit and a custom bootloader.",
        language: "C",
        topics: [],
        updated: "1 May 2026",
        isNew: false
    },
    {
        ...
        cat: "ai",
        desc: "World2Agent (W2A) is an open protocol that standardizes how AI agents perceive the real world.",
        language: "TypeScript",
        topics: ["agent", "proactive_agent", "protocol"],
        updated: "1 May 2026",
        isNew: false
    },
    {
        ...
        cat: "ai",
        desc: "Open-source AI legal platform.",
        language: "TypeScript",
        topics: [],
        updated: "1 May 2026",
        isNew: false
    },
    {
        ...
        cat: "ai",
        desc: "A Codex-powered Chrome side-panel assistant for page context, tabs, voice, and image workflows.",
        language: "TypeScript",
        topics: [],
        updated: "1 May 2026",
        isNew: false
    },
    {
        ...
        cat: "security",
        desc: "A Domain-Fronting Relay that routes traffic through Google Apps Script and forwards it to Cloudflare Workers. Designed to bypass DPI.",
        language: "Python",
        topics: [],
        updated: "2 May 2026",
        isNew: false
    },
    {
        ...
        cat: "dev",
        desc: "Codex++ tweak system for the Codex desktop app.",
        language: "TypeScript",
        topics: [],
        updated: "2 May 2026",
        isNew: false
