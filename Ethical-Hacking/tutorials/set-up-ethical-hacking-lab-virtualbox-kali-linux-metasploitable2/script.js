...
function downloadImage(filename = "ethical-hacking-lab-workflow.webp", filePath = "images/ethical-hacking-lab-workflow.webp") {
...
// ── Run on page load ──────────────────────────────────
document.addEventListener('DOMContentLoaded', loadDeals);document.addEventListener("DOMContentLoaded", () => {
    (function () {
        const el = document.getElementById("brand");
        const text = el.dataset.text || "DevSpire";
        let i = 0;
